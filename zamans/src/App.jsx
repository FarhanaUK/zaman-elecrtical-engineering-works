...
function App() {
  ...
  return (
   ...
   <Call/>
        ...
        font-arsenal">Zamans Electrical Engineering Works</h1>
<p className='font-arsenal text-center text-green-500 text-xl mb-8'>Services for Domestic and Commercial Premisses</p>
